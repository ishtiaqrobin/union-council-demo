...
const ICON_MAP: Record<string, React.ReactNode> = {
  UserCheck: <UserCheck className="w-6 h-6 text-emerald-500 dark:text-emerald-400" />,
  Users: <Users className="w-6 h-6 text-blue-500 dark:text-blue-400" />,
  UserCheck2: <UserCheck2 className="w-6 h-6 text-indigo-500 dark:text-indigo-400" />,
  ShieldCheck: <ShieldCheck className="w-6 h-6 text-teal-500 dark:text-teal-400" />,
  Home: <CheckCircle2 className="w-6 h-6 text-purple-500 dark:text-purple-400" />,
  FileCheck: <FileCheck className="w-6 h-6 text-rose-500 dark:text-rose-400" />,
  HeartHandshake: <HeartHandshake className="w-6 h-6 text-amber-500 dark:text-amber-400" />,
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-100 dark:bg-slate-950 font-siliguri text-slate-900 dark:text-slate-100 transition-colors duration-200">
      {/* Top Navbar */}
      <Navbar />
          ...
          <div className="relative z-10 flex flex-col items-start gap-5 max-w-3xl">
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-200 dark:border-slate-800/80 w-full max-w-lg">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-slate-500 dark:text-slate-400">লাইভ ডাটা সিঙ্ক</span>
              </div>
            </div>
          </div>
        </section>
      ...
      {/* Footer */}
      <footer className="no-print border-t border-slate-200 dark:border-slate-800 py-6 text-center text-xs text-slate-500 dark:text-slate-500 font-siliguri">
