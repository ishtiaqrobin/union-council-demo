        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-base font-bold text-slate-900 dark:text-slate-100 leading-none">
              {isEn ? "Trade License Form Editor" : "ট্রেড লাইসেন্স তথ্য এডিটর"}
            </h3>
      ...
      <div className="p-5 flex flex-col gap-6 overflow-y-auto">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
              ...
              <input type="text" value={getMetaValue("ward_no")} onChange={(e) => updateMeta("ward_no", e.target.value)} className={inputClass} />
            </div>
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
                {isEn ? "Circle/Road/Mohalla" : "সার্কেল/রাস্তা/মহল্লা"}
              </label>
              <input type="text" value={getMetaValue("circle_road_mohalla")} onChange={(e) => updateMeta("circle_road_mohalla", e.target.value)} className={inputClass} />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
              {isEn ? "Valid Until Date" : "মেয়াদ উত্তীর্ণের তারিখ"}
            </label>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2 text-xs font-bold text-rose-600 dark:text-rose-400 uppercase tracking-wider pb-1 border-b border-slate-200 dark:border-slate-800">
            <Briefcase className="w-4 h-4" /> {isEn ? "Business Details" : "প্রতিষ্ঠানের বিবরণ"}
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
          ...
          <div className="flex flex-col gap-1">
            ...
            <textarea value={getBusinessValue("business_type")} onChange={(e) => updateBusiness("business_type", e.target.value)} className={`${inputClass} h-16`} />
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
              {isEn ? "Business Nature" : "ব্যবসার প্রকৃতি"}
            </label>
            <input type="text" value={getBusinessValue("business_nature")} onChange={(e) => updateBusiness("business_nature", e.target.value)} className={inputClass} />
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2 text-xs font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider pb-1 border-b border-slate-200 dark:border-slate-800">
            <User className="w-4 h-4" /> {isEn ? "Owner Information" : "লাইসেন্সধারীর তথ্য"}
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
              {isEn ? "Owner Name" : "লাইসেন্সধারীর নাম"}
            </label>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
              ...
              <input type="text" value={getOwnerValue("father_name")} onChange={(e) => updateOwner("father_name", e.target.value)} className={inputClass} />
            </div>
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
              {isEn ? "Spouse's Name" : "স্বামী/স্ত্রীর নাম"}
            </label>
            <input type="text" value={getOwnerValue("spouse_name")} onChange={(e) => updateOwner("spouse_name", e.target.value)} className={inputClass} />
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input type="text" value={getOwnerValue("present_address")} onChange={(e) => updateOwner("present_address", e.target.value)} className={inputClass} />
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
                {isEn ? "NID / BC No." : "এনআইডি/বিআর নং"}
              </label>
              <input type="text" value={getOwnerValue("nid_or_bc")} onChange={(e) => updateOwner("nid_or_bc", e.target.value)} className={inputClass} />
            </div>
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
                {isEn ? "Mobile No." : "মোবাইল নং"}
              </label>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
                {isEn ? "Tax Zone" : "করঅঞ্চল"}
              </label>
              <input type="text" value={getOwnerValue("tax_zone")} onChange={(e) => updateOwner("tax_zone", e.target.value)} className={inputClass} />
            </div>
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
                {isEn ? "TIN No." : "টিন নং"}
              </label>
              <input type="text" value={data.owner.tin_no || ""} onChange={(e) => onChange({ ...data, owner: { ...data.owner, tin_no: e.target.value } })} className={inputClass} />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2 text-xs font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider pb-1 border-b border-slate-200 dark:border-slate-800">
            <DollarSign className="w-4 h-4" /> {isEn ? "Financial Breakdown (Fees & Tax)" : "আর্থিক বিবরণী (ফি ও কর)"}
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">
                {isEn ? "VAT Amount" : "ভ্যাট (টাকা)"}
              </label>
              <input type="text" value={data.financials.vat} onChange={(e) => onChange({ ...data, financials: { ...data.financials, vat: e.target.value } })} className={inputClass} />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
