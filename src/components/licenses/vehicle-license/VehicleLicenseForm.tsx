    ...
    <aside className="no-print edit-drawer w-full sm:w-[420px] bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 shadow-2xl h-[calc(100vh-62px)] overflow-y-auto sticky top-[62px] z-[500] flex flex-col font-siliguri transition-colors duration-200">
      ...
      <div className="p-5 flex flex-col gap-6 overflow-y-auto">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">মেয়াদ বলবৎ তারিখ</label>
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">নবায়নের শেষ তারিখ</label>
              <input type="text" value={data.meta.renewal_deadline_date} onChange={(e) => updateMeta("renewal_deadline_date", e.target.value)} className={inputClass} />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2 text-xs font-bold text-rose-600 dark:text-rose-400 uppercase tracking-wider pb-1 border-b border-slate-200 dark:border-slate-800">
            <Briefcase className="w-4 h-4" /> যানবাহনের বিবরণ
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">১। যানবাহনের নাম</label>
            <input type="text" value={data.vehicle.name} onChange={(e) => updateVehicle("name", e.target.value)} className={inputClass} />
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">২। যানবাহনের ধরণ</label>
            <textarea value={data.vehicle.type} onChange={(e) => updateVehicle("type", e.target.value)} className={`${inputClass} h-16`} />
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">১০। চলাচলের স্থান</label>
            <input type="text" value={data.vehicle.route_place} onChange={(e) => updateVehicle("route_place", e.target.value)} className={inputClass} />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2 text-xs font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider pb-1 border-b border-slate-200 dark:border-slate-800">
            <User className="w-4 h-4" /> মালিকের তথ্য
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">৩। মালিকের নাম</label>
            <input type="text" value={data.owner.name} onChange={(e) => updateOwner("name", e.target.value)} className={inputClass} />
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">৪। পিতা/স্বামীর নাম</label>
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">৫। মাতার নাম</label>
              <input type="text" value={data.owner.mother_name} onChange={(e) => updateOwner("mother_name", e.target.value)} className={inputClass} />
            </div>
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">৬। স্থায়ী ঠিকানা</label>
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">৭। বর্তমান ঠিকানা</label>
            <textarea value={data.owner.present_address} onChange={(e) => updateOwner("present_address", e.target.value)} className={`${inputClass} h-16`} />
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">৮। এনআইডি নং</label>
              <input type="text" value={data.owner.nid_no} onChange={(e) => updateOwner("nid_no", e.target.value)} className={inputClass} />
            </div>
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">৯। মোবাইল নং</label>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2 text-xs font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider pb-1 border-b border-slate-200 dark:border-slate-800">
            <DollarSign className="w-4 h-4" /> ১২। আর্থিক বিবরণী
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">পেশাজীবি কর</label>
              <input type="text" value={data.financials.profession_tax} onChange={(e) => updateFinancials("profession_tax", e.target.value)} className={inputClass} />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">ভ্যাট আয়কর</label>
              <input type="text" value={data.financials.vat_income_tax} onChange={(e) => updateFinancials("vat_income_tax", e.target.value)} className={inputClass} />
            </div>
            <div className="flex flex-col gap-1">
