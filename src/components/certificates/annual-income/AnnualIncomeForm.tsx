...
import { X, RotateCcw, Building2, FileText, User, PenTool, DollarSign, Info } from "lucide-react";
      ...
      <div className="p-5 flex flex-col gap-6 overflow-y-auto">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input type="text" value={data.incomeAmountBn || ""} onChange={(e) => onChange({ ...data, incomeAmountBn: e.target.value })} className={inputClass} />
          </div>
        </div>
