...
export function AnnualIncomeSheet({ data }: AnnualIncomeSheetProps) {
  const { union, meta, applicant, signatory, incomeAmountBn } = data;
    ...
    >
      ...
      <div className="flex justify-between items-center text-[12px] text-gray-800 font-sans px-1 pb-1">
        ...
        <div className="font-bold text-slate-900 text-[13px] font-solaiman">
          {meta.cert_title || "বার্ষিক আয় প্রত্যয়ন"}
        </div>
