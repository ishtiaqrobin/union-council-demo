...
interface AnnualIncomeSheetProps {
  data: CertificateData;
  lang?: "bn" | "en";
}

export function AnnualIncomeSheet({ data, lang = "bn" }: AnnualIncomeSheetProps) {
  const { union, meta, applicant, signatory, incomeAmountBn, incomeAmountEn } = data;
    ...
    >
      ...
      <div className="flex justify-between items-center text-xs text-black font-sans px-1 pb-1">
        ...
        <div className={`text-black text-sm ${isEn ? "font-sans" : "font-solaiman"}`}>
          {isEn ? (meta.cert_title_en || "Annual Income Certificate") : (meta.cert_title || "বার্ষিক আয় প্রত্যয়ন")}
        </div>
          ...
          <div className="cert-meta-ribbon flex justify-between items-center mt-[10px] px-1">
            ...
            <div className="meta-badge-container flex justify-center flex-1">
              <div className="cert-badge bg-emerald-700 text-white text-xl font-semibold px-9 py-1 rounded-[4px] tracking-wide inline-block shadow-sm">
                {isEn ? (meta.cert_title_en || "Annual Income Certificate") : meta.cert_title}
              </div>
            </div>
          ...
          <div className="cert-content-body mt-6 px-2 flex-1 flex flex-col justify-start">
            {isEn ? (
              <p className="cert-paragraph text-base leading-[2.2] text-black text-justify font-sans">
                ...
                is personally known to me. He/She is a permanent resident of this Union Parishad and a citizen of Bangladesh. To the best of my knowledge and belief, his/her total annual income from all legitimate sources according to profession is{" "}
                <span className="font-semibold text-black border-b border-dotted border-black pb-[1px]">
                  {incomeAmountEn || incomeAmountBn || "1,50,000/- (One Lakh Fifty Thousand BDT)"}
                </span>
                .
              </p>
            ) : (
              <p className="cert-paragraph text-base leading-[2.2] text-black text-justify font-solaiman">
                ...
                কে আমি ব্যক্তিগত ভাবে চিনি ও জানি। তিনি এ ইউনিয়নের স্থায়ী বাসিন্দা ও বাংলাদেশের নাগরিক। আমার জানামতে তাহার পেশা মোতাবেক বার্ষিক আয়{" "}
                <span className="font-semibold text-black border-b border-dotted border-black pb-[1px]">
            ...
            <p className={`cert-closing text-base font-semibold text-black mt-3 pl-[16px] ${isEn ? "font-sans" : "font-solaiman"}`}>
              {isEn
                ...
                : "আমি তাহার সার্বিক উন্নতি ও সাফল্য কামনা করি।"}
            </p>
          </div>
