  ...
  return (
    <aside className="no-print edit-drawer w-full sm:w-[420px] bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 shadow-2xl h-[calc(100vh-62px)] overflow-y-auto sticky top-[62px] z-[500] flex flex-col font-siliguri transition-colors duration-200">
      ...
      <div className="p-5 flex flex-col gap-6 overflow-y-auto">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2 text-xs font-bold text-rose-600 dark:text-rose-400 uppercase tracking-wider pb-1 border-b border-slate-200 dark:border-slate-800">
            <User className="w-4 h-4" /> আবেদনকারীর নামসমূহ
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold">মূল নাম (এনআইডি অনুযায়ী)</label>
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-rose-600 dark:text-rose-400">অন্য নাম / উপনাম</label>
            <input type="text" value={data.aliasNameBn || ""} onChange={(e) => onChange({ ...data, aliasNameBn: e.target.value })} className="px-3 py-2 bg-slate-50 dark:bg-slate-800/90 border border-slate-300 dark:border-slate-700 rounded-lg text-sm font-bold text-rose-600 dark:text-rose-300" />
          </div>
          <div className="flex flex-col gap-1">
