...
export function TradeLicenseSheet({ data }: TradeLicenseSheetProps) {
  const { union, meta, applicant, signatory, businessNameBn, businessTypeBn, licenseFeeBn, customDescriptionBn } = data;
  ...
  return (
    <div
      id="certificateSheet"
      className="certificate-sheet w-[297mm] h-[210mm] min-w-[297mm] min-h-[210mm] bg-white shadow-2xl relative overflow-hidden box-border font-siliguri text-[#121212] px-8 py-4 flex flex-col justify-between print:w-[297mm] print:h-[210mm] print:min-w-[297mm] print:min-h-[210mm] print:max-w-[297mm] print:max-h-[210mm] print:m-0 print:shadow-none print:absolute print:top-0 print:left-0 print:break-inside-avoid"
    >
      ...
      <div className="flex justify-between items-center text-[12px] text-gray-800 font-sans px-1 pb-1">
        ...
        <div className="font-bold text-slate-900 text-[13px] font-solaiman">
          {meta.cert_title || "পেশা ও জীবিকা লাইসেন্স"}
        </div>
        ...
        <div className="certificate-inner-frame w-full h-full bg-white pt-5 px-12 pb-4 relative flex flex-col justify-between z-10">
          ...
          <div className="cert-meta-ribbon flex justify-between items-center mt-[10px] px-1">
            <div className="meta-item meta-serial text-[14px] text-[#121212]">
              <span className="lbl font-semibold mr-1.5">লাইসেন্স নং:</span>
            ...
            <div className="meta-badge-container flex justify-center flex-1">
              <div className="cert-badge bg-blue-700 text-white text-[15.5px] font-bold px-[32px] py-[3.5px] rounded-md tracking-wide inline-block shadow-sm">
                {meta.cert_title}
              </div>
            </div>
          ...
          <div className="cert-content-body mt-4 px-2 flex-1 flex flex-col justify-start gap-3">
            <p className="cert-paragraph text-[14.5px] leading-[2.1] text-gray-900 text-justify">
              ...
              <span className="font-bold text-blue-700 border-b border-dotted border-gray-600 pb-[1px]">
                {businessNameBn || "প্রতিষ্ঠানের নাম"}
              </span>{" "}
              এর অনুকূলে <span className="font-semibold">{businessTypeBn || "ব্যবসার ধরন"}</span> পরিচালনার নিমিত্তে নির্ধারিত ফি{" "}
              <span className="font-bold text-emerald-700">{licenseFeeBn || "ফি"}</span> আদায়পূর্বক এই পেশা ও জীবিকা লাইসেন্স প্রদান করা হইল।
            </p>

            <div className="p-2 bg-slate-50 border border-slate-300 rounded-md text-xs font-semibold text-slate-700 text-center">
