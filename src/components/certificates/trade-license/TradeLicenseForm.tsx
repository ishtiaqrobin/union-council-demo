      ...
      <div className="p-5 flex flex-col gap-6 overflow-y-auto">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 gap-2.5">
            <div className="flex flex-col gap-1">
              <label className="text-xs font-semibold">লাইসেন্স নং</label>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold">প্রতিষ্ঠানের নাম</label>
            <input type="text" value={data.businessNameBn || ""} onChange={(e) => onChange({ ...data, businessNameBn: e.target.value })} className="px-3 py-2 bg-slate-50 dark:bg-slate-800/90 border border-slate-300 dark:border-slate-700 rounded-lg text-sm font-bold text-blue-600 dark:text-blue-400" />
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold">ব্যবসার ধরন</label>
            <input type="text" value={data.businessTypeBn || ""} onChange={(e) => onChange({ ...data, businessTypeBn: e.target.value })} className="px-3 py-2 bg-slate-50 dark:bg-slate-800/90 border border-slate-300 dark:border-slate-700 rounded-lg text-sm" />
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold">লাইসেন্স ফি</label>
            <input type="text" value={data.licenseFeeBn || ""} onChange={(e) => onChange({ ...data, licenseFeeBn: e.target.value })} className="px-3 py-2 bg-slate-50 dark:bg-slate-800/90 border border-slate-300 dark:border-slate-700 rounded-lg text-sm" />
          </div>
        </div>
