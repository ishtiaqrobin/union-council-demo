...
export function CitizenshipSheet({ data, lang = "bn" }: CitizenshipSheetProps) {
    ...
    >
      ...
      <div className="flex justify-between items-center text-xs text-black font-sans px-1 pb-1">
        ...
        <div className={`text-black text-sm ${isEn ? "font-sans" : "font-solaiman"}`}>
          {isEn ? (meta.cert_title_en || "Citizenship Certificate") : (meta.cert_title || "নাগরিক সনদ")}
        </div>
        ...
        <div className="certificate-inner-frame w-full h-full bg-white pt-5 px-12 pb-4 relative flex flex-col justify-between z-10 flex-1 border border-amber-200">
          ...
          <div className="cert-meta-ribbon flex justify-between items-center mt-[10px] px-1">
            <div className="meta-item meta-serial text-base text-[#121212]">
              <span className="lbl mr-1.5">{isEn ? "Serial No:" : "স্মারক নং:"}</span>
            ...
            <div className="meta-badge-container flex justify-center flex-1">
              <div className="cert-badge bg-red-800 text-white text-xl font-semibold px-9 py-1 rounded-[4px] tracking-wide inline-block shadow-sm">
                {isEn ? (meta.cert_title_en || "Citizenship Certificate") : meta.cert_title}
              </div>
            </div>
          ...
          <div className="cert-content-body mt-6 px-2 flex-1 flex flex-col justify-start">
            {isEn ? (
              <p className="cert-paragraph text-base leading-[2.2] text-black text-justify font-sans">
                ...
                . Verified by the Birth Registration / NID records and as per information from the UP Member of Ward No.{" "}
                <span className="font-semibold border-b border-dotted border-black pb-[1px]">
                  {applicant.ward_no_en || applicant.ward_no}
                </span>
                ...
                of this Union Parishad and a citizen of Bangladesh by birth.
              </p>
            ) : (
