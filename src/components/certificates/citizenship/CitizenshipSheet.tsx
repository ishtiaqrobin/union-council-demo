  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center text-xs text-black font-sans px-1 pb-1">
        ...
        <div className="text-black00 text-sm font-solaiman">
        ...
        <div className="certificate-inner-frame w-full h-full bg-white pt-5 px-12 pb-4 relative flex flex-col justify-between z-10 flex-1 border border-amber-200">
          ...
          <div className="cert-header grid grid-cols-[76px_1fr_76px] items-center text-center relative">
            ...
            <div className="header-titles flex flex-col items-center justify-center">
              ...
              <div className="up-sub-address text-xl font-semibold text-black00 mt-[1px]">
                উপজেলা: <span>{union.upazila}</span>, জেলা: <span>{union.district}</span>।
              </div>
              <div className="up-web-url font-siliguri text-sm font-semibold text-black00 mt-[1px]">
                {union.website}
              </div>
            </div>
