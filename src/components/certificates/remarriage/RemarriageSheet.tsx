...
export function RemarriageSheet({ data, lang = "bn" }: RemarriageSheetProps) {
          ...
          <div className="cert-meta-ribbon flex justify-between items-center mt-[10px] px-1">
            ...
            <div className="meta-badge-container flex justify-center flex-1">
              <div className="cert-badge bg-green-700 text-white text-xl font-semibold px-9 py-1 rounded-[4px] tracking-wide inline-block shadow-sm">
                {isEn ? (meta.cert_title_en || "Non-Remarriage Certificate") : meta.cert_title}
              </div>
            </div>
          ...
          <div className="cert-content-body mt-6 px-2 flex-1 flex flex-col justify-start">
            {isEn ? (
              <p className="cert-paragraph text-base leading-[2.2] text-black text-justify font-sans">
                ...
                <span className="font-semibold border-b border-dotted border-black pb-[1px]">
                  {applicant.spouse_name_en || applicant.spouse_name || "Spouse Name"}
                </span>
                , Mother:{" "}
                <span className="font-semibold border-b border-dotted border-black pb-[1px]">
                ...
                . Verified by the Birth Registration / NID records and as per the information from the UP Member of Ward No.{" "}
                <span className="font-semibold border-b border-dotted border-black pb-[1px]">
                  {applicant.ward_no_en || applicant.ward_no}
                </span>
                , he/she is a permanent resident of Ward No.{" "}
                <span className="font-semibold border-b border-dotted border-black pb-[1px]">
                  {applicant.ward_no_en || applicant.ward_no}
                </span>
                , Village:{" "}
                ...
                of this Union Parishad and a citizen of Bangladesh by birth. To the best of my knowledge,{" "}
                <span className="font-semibold border-b border-dotted border-black pb-[1px]">
                  {applicant.person_name_en || applicant.person_name}
                </span>{" "}
                has not remarried.
