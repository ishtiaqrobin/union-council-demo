    ...
    <aside className="no-print edit-drawer w-full sm:w-[420px] bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 shadow-2xl h-[calc(100vh-62px)] overflow-y-auto sticky top-[62px] z-[500] flex flex-col font-siliguri transition-colors duration-200">
      ...
      <div className="p-5 flex flex-col gap-6 overflow-y-auto">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold">বর্তমান স্বামীর নাম</label>
            <input type="text" value={data.applicant.spouse_name || ""} onChange={(e) => updateApplicant("spouse_name", e.target.value)} className="px-3 py-2 bg-slate-50 dark:bg-slate-800/90 border border-slate-300 dark:border-slate-700 rounded-lg text-sm" />
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-xs font-semibold text-amber-600 dark:text-amber-400">পুনঃবিবাহ বিবরণ</label>
            <textarea value={data.remarriageReasonBn || ""} onChange={(e) => onChange({ ...data, remarriageReasonBn: e.target.value })} className="px-3 py-2 bg-slate-50 dark:bg-slate-800/90 border border-slate-300 dark:border-slate-700 rounded-lg text-sm h-24" />
          </div>
        </div>
